...
<body class="bg-amber-50 text-stone-800 font-sans">
  <header class="bg-green-700 text-white p-6 text-center rounded-b-2xl shadow-md">
    <h1 class="text-3xl font-bold">EcoBite</h1>
    <p class="text-lg mt-1 italic">Do desperdício à nutrição</p>
  </header>

  <main class="max-w-3xl mx-auto p-6 space-y-8">
    <section class="bg-white rounded-2xl shadow p-6">
      <h2 class="text-2xl font-semibold text-green-800 mb-3">Rastreabilidade do Lote</h2>
      <p><strong>Lote:</strong> EB2025-0034</p>
      <p><strong>Data de Produção:</strong> 12/03/2025</p>
      <p class="mt-3 text-green-700 font-medium">Origem dos excedentes:</p>
      <ul class="list-disc ml-6">
        <li>Hortas Urbanas de Lisboa – 35 kg de cenoura e abóbora</li>
        <li>Supermercado Verde+ – 18 kg de aveia não vendida</li>
        <li>Cooperativa BioMontanha – 12 kg de maçã fora do padrão</li>
      </ul>
    ...
    <section class="bg-white rounded-2xl shadow p-6">
      ...
      <ul class="list-disc ml-6">
        <li>🌍 <strong>CO₂ evitado:</strong> 120 kg (metodologia FAO 2021)</li>
        <li>♻️ <strong>Desperdício redirecionado:</strong> 100% para uso animal seguro</li>
        <li>💧 <strong>Água poupada:</strong> 9.000 L (Our World in Data)</li>
      </ul>
    ...
    <section class="bg-white rounded-2xl shadow p-6">
      ...
      <ul class="list-disc ml-6">
        <li>✅ Teste microbiológico: aprovado (LabVet Lisboa, 2025/034)</li>
        <li>✅ Análise nutricional: proteína 24%, fibra 5%, gordura 10%</li>
    ...
    <section class="bg-green-100 rounded-2xl p-6 border border-green-300">
      ...
      <div class="text-center">
        <p>🌾 Produtor → 🚛 Recolha → 🏭 Produção → 🐕 Cão Feliz → 💚 ONG Parceira</p>
      </div>
